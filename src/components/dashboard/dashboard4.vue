<template lang="html">
  <div class="dashboard">
    <div class="flex-container column" >
        ...
        <div class="item two" @click="clickChart('2')" style="transform: translate(-22.4%,-11.5%) scale(0.25)">
          <column></column>
        </div>
        <div class="item three" @click="clickChart('3')" style="transform: translate(-22.4%,14%) scale(0.25)">
          <v-line></v-line>
        </div>
        <div class="item four active" @click="clickChart('4')" style="transform: translate(43.7%, 0) scale(1)">
          <point></point>
        </div>
        <div class="item five " @click="clickChart('5')" style="transform: translate(-22.4%,39.5%) scale(0.25)">
          <funnel></funnel>
        </div>
